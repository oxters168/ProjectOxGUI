    ...
    public abstract class OxListable : OxGUI
    {
        ...
        public void FillBrowserList(string currentDir, bool includeFiles, string extension)
        {
            ...
            if (!Directory.Exists(directoryView))
            {
                ...
                try { text = Directory.GetCurrentDirectory(); } catch (Exception e) { Debug.Log("Error getting current directory: " + e.Message); }
                directoryView = text;
            }
            ...
            try { parent = Directory.GetParent(directoryView); } catch (Exception e) { Debug.Log("Error getting parent directory: " + e.Message); }
            if (parent != null)
            {
            ...
            try { directories = Directory.GetDirectories(directoryView); } catch (Exception e) { Debug.Log("Error getting directories in current folder: " + e.Message); }
            ...
            if (includeFiles)
            {
                ...
                catch (Exception e) { Debug.Log("Error getting files in directory: " + e.Message); }
